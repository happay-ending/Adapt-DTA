...
class DependentBackend():
    def __init__(self):
        super(DependentBackend).__init__()
        self.backend_config = _generate_backend_config()
        _backend_logger.info("Adopted backend: %s" % str(self.backend_config))

    def get_backend_name(self) -> str:
        return str(self.backend_config)

    def is_dgl(self) -> bool:
        return isinstance(self.backend_config, _DGLConfig)

    def is_pyg(self) -> bool:
        return isinstance(self.backend_config, _PyGConfig)
