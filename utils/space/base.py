...
# from autogl.module.nas.utils import get_hardware_aware_metric
...
from utils.model.nas_utils import get_hardware_aware_metric
...
class BoxModel(BaseAutoModel):
    ...
    # _logger = get_logger("cpi_graphnas2")

    def __init__(self, space_model, device):
        super().__init__(None, None, None,device)
        self.init = True
        self.space = []
        self.hyperparams = {}
        self._model = space_model
        self.mol_num_features = self._model.mol_input_dim
        self.prt_num_features = self._model.prt_input_dim
        self.num_classes = self._model.output_dim
        self.params = {"num_class": self.num_classes, "mol_features_num": self.mol_num_features,"prt_features_num": self.prt_num_features}
        self.selection = None
