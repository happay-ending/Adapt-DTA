...
from utils.model.auto_module import AutoModule
...
class BaseAutoModel(AutoModule):
    def __init__(self, mol_input_dimension,prt_input_dimension, output_dimension, device, **kwargs):
        # self._input_dimension = input_dimension
        self._mol_input_dimension = mol_input_dimension
        self._prt_input_dimension = prt_input_dimension
    ...
    def from_hyper_parameter(self, hp, **kwargs):
        ...
        ret_self = self.__class__(
            self._mol_input_dimension,
            self._prt_input_dimension,
    ...
    @property
    def mol_input_dimension(self):
        return self._mol_input_dimension

    @property
    def prt_input_dimension(self):
        return self._prt_input_dimension

    @mol_input_dimension.setter
    def mol_input_dimension(self, mol_input_dimension):
        self._mol_input_dimension = mol_input_dimension

    @prt_input_dimension.setter
    def prt_input_dimension(self, prt_input_dimension):
        self._prt_input_dimension = prt_input_dimension
